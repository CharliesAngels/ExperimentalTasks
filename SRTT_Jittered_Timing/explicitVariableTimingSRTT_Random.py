...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.81.03), Mon Aug  7 11:50:47 2017
...
Blocks = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('explicitSRTT_Random.xlsx'),
...
for thisBlock in Blocks:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # *text* updates
        if t >= 8 and text.status == NOT_STARTED:
            # keep track of start time/frame for later
            text.tStart = t  # underestimates by a little under one frame
            text.frameNStart = frameN  # exact frame index
            text.setAutoDraw(True)
        if text.status == STARTED and t >= (8 + (2-win.monitorFramePeriod*0.75)): #most of one frame period left
