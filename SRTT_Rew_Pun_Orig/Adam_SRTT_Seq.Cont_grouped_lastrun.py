...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.80.06), Sat Dec  6 21:37:35 2014
...
expName = 'Adam_SRTT_Cont_grouped'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/steelad/Desktop/Subj_fMRI_Grouped_timedRest_nocounter_framed/Adam_SRTT_Seq.Cont_grouped.psyexp',
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    elif Plus.status == STARTED and t >= (7-win.monitorFramePeriod*0.75): #most of one frame period left
    ...
    elif Plus_ready.status == STARTED and t >= (12-win.monitorFramePeriod*0.75): #most of one frame period left
...
Training_Blocks = data.TrialHandler(nReps=3, method='sequential', 
    extraInfo=expInfo, originPath=u'/Users/steelad/Desktop/Subj_fMRI_Grouped_timedRest_nocounter_framed/Adam_SRTT_Seq.Cont_grouped.psyexp',
    trialList=[None],
...
for thisTraining_Block in Training_Blocks:
    ...
    for thisTrainingLoop in TrainingLoop:
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            elif Training_Stim.status == STARTED and t >= (0.0 + (0.8-win.monitorFramePeriod*0.75)): #most of one frame period left
            ...
            if t >= 0 and Response_Training.status == NOT_STARTED:
                ...
                event.clearEvents(eventType='keyboard')
            elif Response_Training.status == STARTED and t >= (0.8-win.monitorFramePeriod*0.75): #most of one frame period left
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            elif Training_ISI.status == STARTED and t >= (0.0 + (0.2-win.monitorFramePeriod*0.75)): #most of one frame period left
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        elif Training_Rest_Instr.status == STARTED and t >= (0.0 + (5-win.monitorFramePeriod*0.75)): #most of one frame period left
        ...
        elif training_plus.status == STARTED and t >= (25-win.monitorFramePeriod*0.75): #most of one frame period left
        ...
        elif training_plus_prep.status == STARTED and t >= (30-win.monitorFramePeriod*0.75): #most of one frame period left
...
for thisRun1 in Run1:
    ...
    for thisInit_rand in Init_rand:
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            elif RandFB_trial.status == STARTED and t >= (0.0 + (0.8-win.monitorFramePeriod*0.75)): #most of one frame period left
            ...
            elif Stimulus_rand.status == STARTED and t >= (0.8-win.monitorFramePeriod*0.75): #most of one frame period left
            ...
            if t >= 0 and RandResp.status == NOT_STARTED:
                ...
                event.clearEvents(eventType='keyboard')
            elif RandResp.status == STARTED and t >= (0.8-win.monitorFramePeriod*0.75): #most of one frame period left
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            elif FB_Rand.status == STARTED and t >= (0.0 + (0.2-win.monitorFramePeriod*0.75)): #most of one frame period left
            ...
            elif ISI_rand.status == STARTED and t >= (0.0 + (.2-win.monitorFramePeriod*0.75)): #most of one frame period left
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        elif Breather.status == STARTED and t >= (0.0 + (5-win.monitorFramePeriod*0.75)): #most of one frame period left
        ...
        if t >= 5 and plus.status == NOT_STARTED:
            ...
            plus.frameNStart = frameN  # exact frame index
            plus.setAutoDraw(True)
        elif plus.status == STARTED and t >= (25-win.monitorFramePeriod*0.75): #most of one frame period left
            plus.setAutoDraw(False)
        ...
        elif readyPlus.status == STARTED and t >= (30-win.monitorFramePeriod*0.75): #most of one frame period left
    ...
    for thisInit_seq in init_seq:
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            elif FB_Seq_trial.status == STARTED and t >= (0.0 + (0.8-win.monitorFramePeriod*0.75)): #most of one frame period left
            ...
            elif Stimulus_appear.status == STARTED and t >= (0.8-win.monitorFramePeriod*0.75): #most of one frame period left
            ...
            if t >= 0 and Resp.status == NOT_STARTED:
                ...
                event.clearEvents(eventType='keyboard')
            elif Resp.status == STARTED and t >= (0.8-win.monitorFramePeriod*0.75): #most of one frame period left
                Resp.status = STOPPED
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            elif FB_seq.status == STARTED and t >= (0 + (.2-win.monitorFramePeriod*0.75)): #most of one frame period left
            ...
            elif ISI.status == STARTED and t >= (0.0 + (.2-win.monitorFramePeriod*0.75)): #most of one frame period left
