...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.81.03), Sun Feb  1 12:54:13 2015
...
expName = 'Adam_SRTT_Pun_grouped'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/steelad/Desktop/Subj_fMRI_Grouped_timedRest_nocounter_framed/Adam_SRTT_Seq.Pun_grouped.psyexp',
...
Training_Blocks = data.TrialHandler(nReps=3, method='sequential', 
    extraInfo=expInfo, originPath=u'/Users/steelad/Desktop/Subj_fMRI_Grouped_timedRest_nocounter_framed/Adam_SRTT_Seq.Pun_grouped.psyexp',
    trialList=[None],
...
for thisRun1 in Run1:
    ...
    phrase = str('You will now complete a series of the trials.\n\nAs you continue, you will have feedback based on your speed and accuracy, indicated by the appearance of a red rectangle. \nThis feedback indicates you have lost money.\nYou will begin with $60.\n\nAgain, please respond as fast and accurately as possible.\n\nPress space to go on')
