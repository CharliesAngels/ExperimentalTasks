...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.81.03), Thu Sep 10 13:38:50 2015
...
expName = 'Adam_SRTT_Rew_grouped'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/steelad/Desktop/Subj_fMRI_Grouped_timedRest_nocounter_framed/Adam_SRTT_Seq.Rew_grouped.psyexp',
...
Training_Blocks = data.TrialHandler(nReps=3, method='sequential', 
    extraInfo=expInfo, originPath=u'/Users/steelad/Desktop/Subj_fMRI_Grouped_timedRest_nocounter_framed/Adam_SRTT_Seq.Rew_grouped.psyexp',
    trialList=[None],
...
for thisRun1 in Run1:
    ...
    breatherphrase = str("Good job, you finished block %s.  \n \nTake a breather. \n \nYou have earned $%s" % (block, e_string))
    block = block+1
...
seq_pos_filename = 'sequence_position_filename_%s.txt' %(expInfo['participant'])
seq_pos_file = open(seq_pos_filename,'w')
write_seq = csv.writer(seq_pos_filename)
write_seq = csv.writerow(sequence_positions)
